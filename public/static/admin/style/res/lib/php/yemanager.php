        ...
        <div class="card mb-2 fm-upload-wrapper <?php echo fm_get_theme(); ?>">
            <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#urlUploader" class="js-url-upload" data-target="#urlUploader"><i class="fa fa-link"></i> 从 URL 上传</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
...
function lng($txt) {
    ...
    $tr['en']['Login']          = '登入';                $tr['en']['Username']           = 'Username';
    $tr['en']['Password']       = '密码';               $tr['en']['Logout']             = 'Sign Out';
    $tr['en']['Move']           = '移动';                   $tr['en']['Copy']               = '复制';
    $tr['en']['Save']           = '节省';                   $tr['en']['SelectAll']          = '全选';
    $tr['en']['UnSelectAll']    = '全部取消';           $tr['en']['File']               = '文件';
    $tr['en']['Back']           = '后退';                   $tr['en']['Size']               = '大小';
    $tr['en']['Perms']          = 'Perms';                  $tr['en']['Modified']           = '修改时间';
    $tr['en']['Owner']          = '所有人';                  $tr['en']['Search']             = '搜索';
    $tr['en']['NewItem']        = 'New Item';               $tr['en']['Folder']             = '文件夹';
    $tr['en']['Delete']         = '删除';                 $tr['en']['Rename']             = '重命名';
    $tr['en']['CopyTo']         = '复制到';                $tr['en']['DirectLink']         = '查看文件链接';
    $tr['en']['UploadingFiles'] = '上传文件';           $tr['en']['ChangePermissions']  = '更改权限';
    $tr['en']['Copying']        = '复印';                $tr['en']['CreateNewItem']      = '创建新项目';
    $tr['en']['Name']           = '文件名';                   $tr['en']['AdvancedEditor']     = '高级编辑器';
    $tr['en']['RememberMe']     = '记住账号';            $tr['en']['Actions']            = '开始';
    $tr['en']['Upload']         = '上传';                 $tr['en']['Cancel']             = '取消';
    $tr['en']['InvertSelection']= '反转选择';       $tr['en']['DestinationFolder']  = '目标文件夹';
    $tr['en']['ItemType']       = 'Item Type';              $tr['en']['ItemName']           = '项目名称';
    $tr['en']['CreateNow']      = '立即创建';             $tr['en']['Download']           = '下载';
    $tr['en']['Open']           = '打开';                   $tr['en']['UnZip']              = '解压缩';
    $tr['en']['UnZipToFolder']  = '解压到文件夹';        $tr['en']['Edit']               = '编辑';
    $tr['en']['NormalEditor']   = '普通编辑器';          $tr['en']['BackUp']             = '备份';
    $tr['en']['SourceFolder']   = '源文件夹';          $tr['en']['Files']              = '文件';
    $tr['en']['Move']           = '移动';                   $tr['en']['Change']             = '改变';
    $tr['en']['Settings']       = '设置';               $tr['en']['Language']           = '语言';
    $tr['en']['Folder is empty']    = '文件夹为空';    $tr['en']['PartitionSize']      = '分区大小';
    $tr['en']['ErrorReporting'] = '错误报告';        $tr['en']['ShowHiddenFiles']    = '显示隐藏文件';
    $tr['en']['Full size']      = '总大小';              $tr['en']['Help']               = '帮助';
    $tr['en']['Free of']        = '总大小';                $tr['en']['Preview']            = '预览';
    $tr['en']['Help Documents'] = '帮助文档';         $tr['en']['Report Issue']       = '报告问题';
    $tr['en']['Generate']       = '产生';               $tr['en']['FullSize']           = '总大小';
    $tr['en']['FreeOf']         = '总大小';                $tr['en']['CalculateFolderSize']= '计算文件夹大小';
    $tr['en']['ProcessID']      = '进程 ID';             $tr['en']['Created']    = 'Created';
    $tr['en']['HideColumns']    = '隐藏 Perms/Owner 列';$tr['en']['You are logged in'] = '您已登录';
    $tr['en']['Check Latest Version'] = '检查最新版本';$tr['en']['Generate new password hash'] = '生成新密码哈希';
    $tr['en']['Login failed. Invalid username or password'] = '登录失败。 用户名或密码无效';
    $tr['en']['password_hash not supported, Upgrade PHP version'] = '不支持密码哈希，升级 PHP 版本';

    // new - novos

    $tr['en']['Advanced Search']    = 'Advanced Search';    $tr['en']['Error while copying from']    = 'Error while copying from';
    $tr['en']['Nothing selected']   = '没有选择任何文件';   $tr['en']['Paths must be not equal']    = 'Paths must be not equal';
    ...
    $tr['en']['Create archive?']    = '确定压缩文件？';    $tr['en']['Invalid file or folder name']    = 'Invalid file or folder name';
